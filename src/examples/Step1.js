              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <div className="col-md-6">
                    ...
                    <code>showSteps=true<br />showNavigation=true<br />stepsNavigation=true<br />prevBtnOnLastStep=true<br />dontValidate=false<br />preventEnterSubmission=false<br />startAtStep=0<br />nextTextOnFinalActionStep='Next'</code>
                  </div>
                </div>
              </div>
            </div>
