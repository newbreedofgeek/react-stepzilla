...
var StepZilla = function (_Component) {
  ...
  function StepZilla(props) {
    ...
    _this.prevClassName = _this.props.prevClassName || 'btn btn-prev btn-primary btn-lg pull-left';
    _this.nextClassName = _this.props.nextClassName || 'btn btn-next btn-primary btn-lg pull-right';
  ...
  _createClass(StepZilla, [{
    ...
    value: function next() {
      ...
      this.abstractStepMoveAllowedToPromise().then(function () {
        ...
        if (_this4.isLastStep() && _this4.props.onAfterLastStep) {
          _this4.props.onAfterLastStep();
          return;
        }
